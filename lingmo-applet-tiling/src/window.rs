...
const ID: &str = "com.lingmoos.LingmoAppletTiling";
const ON: &str = "com.lingmoos.LingmoAppletTiling.On";
const OFF: &str = "com.lingmoos.LingmoAppletTiling.Off";
...
impl cosmic::Application for Window {
    ...
    fn init(core: Core, _flags: Self::Flags) -> (Self, app::Task<Self::Message>) {
        let config_helper =
            Config::new("com.lingmoos.LingmoComp", CosmicCompConfig::VERSION).unwrap();
    ...
    fn subscription(&self) -> Subscription<Self::Message> {
        Subscription::batch([
            self.core
                .watch_config::<CosmicCompConfig>("com.lingmoos.LingmoComp")
