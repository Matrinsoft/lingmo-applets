...
use lingmo_settings_a11y_manager_subscription::{
    self as cosmic_a11y_manager, AccessibilityEvent, AccessibilityRequest, ColorFilter,
};
use lingmo_settings_accessibility_subscription::{self as accessibility};
use std::sync::LazyLock;
use tokio::sync::mpsc::UnboundedSender;

pub fn run() -> cosmic::iced::Result {
    cosmic::applet::run::<LingmoA11yApplet>(())
}

#[derive(Clone, Default)]
struct LingmoA11yApplet {
...
impl cosmic::Application for LingmoA11yApplet {
    type Message = Message;
    type Executor = cosmic::SingleThreadExecutor;
    type Flags = ();
    const APP_ID: &'static str = "com.lingmoos.LingmoAppletA11y";
