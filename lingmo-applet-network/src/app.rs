...
pub fn run() -> cosmic::iced::Result {
    cosmic::applet::run::<LingmoNetworkApplet>(())
}
...
impl cosmic::Application for LingmoNetworkApplet {
    ...
    fn init(core: cosmic::app::Core, _flags: ()) -> (Self, app::Task<Message>) {
        ...
        let my_id =
            format!("com.lingmoos.LingmoSettings.Applet._{uuid}.NetworkManager.SecretAgent",);
